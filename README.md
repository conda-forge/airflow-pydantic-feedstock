About airflow-pydantic-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airflow-pydantic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airflow-pydantic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airflow-pydantic
# for installing globally
pixi global install airflow-pydantic
```
...
It is possible to list all of the versions of `airflow-pydantic` available on your platform:
...
```
pixi search airflow-pydantic --channel conda-forge
```
